        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ExamBoards_Curriculums_CurriculumId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_QuestionFlags_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AnswerFlags_Answers_AnswerId",
                        column: x => x.AnswerId,
                        principalTable: "Answers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AnswerFlags_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AnswerFlags_AnswerId",
                table: "AnswerFlags",
                column: "AnswerId");

            migrationBuilder.CreateIndex(
                name: "IX_AnswerFlags_UserId",
                table: "AnswerFlags",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Curriculums_Name",
                table: "Curriculums",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ExamBoards_CurriculumId",
                table: "ExamBoards",
                column: "CurriculumId");

            migrationBuilder.CreateIndex(
                name: "IX_ExamBoards_Name",
                table: "ExamBoards",
                column: "Name",
                unique: true);
